...
function service(): FileService {
  return {
    openFile: vi.fn().mockResolvedValue({
      name: 'opened.jff', path: 'C:/opened.jff',
      content: '<?xml version="1.0"?><structure><type>fa</type><automaton><state id="0" name="q0"><x>0</x><y>0</y><initial/></state></automaton></structure>',
    }),
...
describe('shared application commands', () => {
  ...
  it('uses the same open, save, and native-menu command behavior', async () => {
    ...
    expect(fileService.saveFile).toHaveBeenCalledWith('opened.jff', expect.any(String), 'C:/opened.jff');
